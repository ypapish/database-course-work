...
| **_ID:_**                | AddUser
---------------------------|-----------------------------
| **_НАЗВА:_**             | Створити обліковий запис користувача.
| **_УЧАСНИКИ:_**          | Користувач, Система.
| **_ПЕРЕДУМОВИ:_**        | Користувач не має облікового запису.
| **_РЕЗУЛЬТАТ:_**         | Створений обліковий запис користувача.
| **_ВИКЛЮЧНІ СИТУАЦІЇ:_** | EX.001 Користвач має обліковий запис. <br/> EX.002 Користувач надав невалідні дані. <br/> EX.003 Обліковий запис з наведеними даннами вже існує в системі.
| **_ОСНОВНИЙ СЦЕНАРІЙ:_** | 1. Користувач надає свої дані. <br/> 2. Система перевіряє валіднасть та унікальність наведених данних (можлива EX.001 та EX.002). <br/> 3. Система створює обліковий запис. <br/> 4. Система повідомляє користувача про успішність виконання операції.

---

| **_ID:_**                | AuthenticationUser
---------------------------|-----------------------------
| **_НАЗВА:_**             | Увійти до облікового запису коричтувача.
| **_УЧАСНИКИ:_**          | Користувач, Система.
| **_ПЕРЕДУМОВИ:_**        | Користувач має обліковий запис.
| **_РЕЗУЛЬТАТ:_**         | Користувач має доступ до всіх сервісів системи.
| **_ВИКЛЮЧНІ СИТУАЦІЇ:_** | EX.001 Користвач не має облікового запису. <br/> EX.002 Користувач надав невалідні дані.
| **_ОСНОВНИЙ СЦЕНАРІЙ:_** | 1. Користувач передає свої дані. <br/> 2. Система перевіряє валідність наведених даних (можлива EX.002). <br/> 3. Система перевіряє існування користувача (можлива EX.001).<br/> 4. Система надає доступ до облікового запису користувачу <br/> 5. Система повідомляє користувача про успішність виконання операції.

---

| **_ID:_**                | DeleteUser
---------------------------|-----------------------------
| **_НАЗВА:_**             | Видалити обліковий запис коричтувача.
| **_УЧАСНИКИ:_**          | Адміністратор, Система.
| **_ПЕРЕДУМОВИ:_**        | Користувач має обліковий запис.
| **_РЕЗУЛЬТАТ:_**         | Відсутність існування облікового запису користувача.
| **_ВИКЛЮЧНІ СИТУАЦІЇ:_** | EX.001 Користвач не має облікового запису. <br/> EX.002 Адміністратор надав неправильні дані. <br/> EX.003 Адміністратор надав невалідні дані.
| **_ОСНОВНИЙ СЦЕНАРІЙ:_** | 1. Адміністратор передає дані користувача, обліковий запис якого потрібно видалити. <br/> 2. Система перевіряє існування користувача (можлива EX.002). <br/> 3. Система видаляє користувача. <br/> 5. Система повідомляє адміністратору про успішність виконання операції.
